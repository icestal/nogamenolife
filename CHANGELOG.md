...
## 2026-09-05 · 新增15款 · 老胡FF7/世界树 + 小寒KEY社4款转可共享
- **总量 1598→1613**:新增 15 款、无消失。全库 **1613 款,可共享 1447**。
- **新增分布**:老胡 FF7 REMAKE/REBIRTH + 世界树的迷宫Ⅰ/Ⅱ/Ⅲ HD 重制三连 + HunterX;ZZZ 火柴人亨利合集;小寒 Little Busters!+Kanon+AIR+信使;老梁 堆叠大陆;木贰 黑枪神悟空+弹球亿万富翁+WRC 越野冠军赛。
- **可共享标记**:小寒 4 款(Little Busters!/Kanon/AIR/信使)经确认均支持共享,补入 `family_library_xiaohan.tsv`;信使真实英文名 The Messenger 一并修正。
- **新系列标签**:最终幻想系列(1462040/2909400)、世界树的迷宫系列(1810820/1868170/1868180)写入 `games_tags.tsv`。
- **小黑盒补中文 5 款**:火柴人亨利合集/堆叠大陆/世界越野冠军赛/最终幻想7+重制版/最终幻想7+重生;仍缺 4 款(Little Busters!/Kanon/AIR 无官方中文 + HunterX)。
- **口径校正**:本期起"可共享"以 games.json `share=True` 实测为准(1432→1447,新增 15 款全部可共享、零翻转);此前 8-23/8-30 两条记的 1448/1457 实为 1423/1432,虚高约 25(误用 DRY_RUN 控制台 family 条数)。

## 2026-08-30 · 新增9款 + 时空之轮/绯红结系/战狗转可共享
- **总量 1589→1598**:新增 9 款、无消失。
- **新增分布**:ZZZ 雨中冒险(RoR初代)+反叛公司+陶艺大师+战狗;小寒 时空之轮+绯红结系;老梁 幻兽大农场+毛茸茸食堂物语;木贰 喷射侠。
- **可共享标记**:小寒 时空之轮/绯红结系 补入 `family_library_xiaohan.tsv`(家庭共享支持已确认);ZZZ 战狗(WARDOGS,家庭清单漏抓)新增 `family_manual.tsv` 手工补充机制——merge.py `FAMILY_FILES` 新增第三项(无条件接受),存已确认可共享但家庭清单漏掉的游戏。
- **新系列标签**:248820 雨中冒险系列。
- **小黑盒补中文 4 款**:雨中冒险/喷射侠/时空之轮/战狗。
- 全库 **1598 款,可共享 1457**。
