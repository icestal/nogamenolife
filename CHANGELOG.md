...
## 2026-08-23 · 新增39款 + 小寒两款转可共享 + 4个新系列
- **总量 1553→1589**:5 人个人库+家庭清单刷新,新增 39 款、消失 1 款(God of Weapons 2342950,以新抓 tsv 为准删除)。
- **新游戏分布**:老胡 轩辕剑系列8款+仙剑系列4款;ZZZ 开罗物语系列14款+雨中冒险2款+地狱已满2+印蒂卡;小寒 多洛可小镇+暗喻幻想;老梁 拾光物语/Hello Kitty/碧海黑帆/造梦西游;木贰 与美女合租99种死法。
- **小寒两款转可共享**:2285550多洛可小镇、2679460暗喻幻想补入 `family_library_xiaohan.tsv`(小寒暂未入组,经确认可共享)。
- **新系列标签 28 行**:轩辕剑系列/仙剑奇侠传系列/开罗物语系列/雨中冒险系列,写入 `games_tags.tsv`。
- **剔除 2 款工具**:Godot Engine、OBS Studio 加入 `games_tools.tsv`(累计 20 款)。
- **小黑盒补中文 1 款**:292000 地狱已满 2;仍缺 1 款(Hello Kitty Island Adventure,小黑盒无中文)。
- 全库 **1589 款,可共享 1448**。
